...
public:
    struct Style {
        DeckMath::Vector4 minor_color { 0.62f, 0.62f, 0.66f, 0.45f };
        DeckMath::Vector4 major_color { 0.42f, 0.42f, 0.48f, 0.75f };
        DeckMath::Vector4 axis_x_color { 0.85f, 0.25f, 0.30f, 0.95f };
        DeckMath::Vector4 axis_z_color { 0.22f, 0.45f, 0.90f, 0.95f };
