...
// Live input sampling now lives in the Raylib backend (Ui::Raylib::ReadKeyboard /
// ReadPointer) so the demo and Graphics::BeginFrame feed the framework identical
// state from one implementation. --shot mode still synthesizes its own input below.
...
int main(int argc, char** argv)
{
    ...
    while (!WindowShouldClose()) {
        ...
        if (shotMode) {
            ...
            Ui::BeginFrame(rootSize, Ui::Raylib::ReadPointer(), Ui::Raylib::ReadKeyboard());
        }
